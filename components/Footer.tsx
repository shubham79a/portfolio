...
const githubProfileLink = "https://github.com/shubham79a";
const linkedinProfileLink =
  "https://www.linkedin.com/in/shubham-kumar-894799290/";
  ...
  return (
    <footer className="w-full mb-[30px] md:mb-4 pb-10" id="contact">
      <div className="flex flex-col items-center">
        ...
        <a href="mailto:shubh79.nolan@gmail.com">
          <MagicButton
